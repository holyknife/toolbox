...
export default function QrGenerator() {
  ...
  async function importBackup(file: File | undefined) {
    ...
    try {
      ...
      setStatus('Reading your backup locally…');
      ...
      setStatus(`Found ${imported.networks.length} networks. Review your selection before generating.`);
    } catch (reason) { if (active.current) { setError(messageFor(reason)); setStatus(''); } }
    finally { if (active.current) setBusy(false); }
  }
