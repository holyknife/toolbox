...
export const tools: Tool[] = [
  { slug: 'word-generator', name: 'Word Generator', description: 'Discover a random English or Nepali word with one tap. Two independent word collections.', icon: Shuffle, category: 'Language', keywords: ['random', 'Nepali', 'words', 'English'] },
  { slug: 'calculators', name: 'Calculators', description: 'From percentages and money to GPA, health, and currency conversion. Fast, accurate, and simple.', icon: Calculator, category: 'Utilities', keywords: ['percentage','percent','BMI','age','loan','EMI','tip','bill splitter','discount','date difference','GPA','grade','currency','forex','exchange rate'] },
